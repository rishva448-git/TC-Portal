        ...
        <div className="w-full bg-gray-900 rounded-2xl p-6 border border-gray-800 shadow-lg relative overflow-hidden group">
          ...
          <div className="flex items-start space-x-4 mb-5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-blue-400 font-medium truncate mb-1">{member.position}</p>
              <div className="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-semibold bg-indigo-500/10 text-indigo-300 border border-indigo-500/20">
          ...
          {member.skills && member.skills.length > 0 && (
            <div className="mb-4">
              <p className="text-[10px] uppercase font-mono text-gray-400 mb-1.5 flex items-center gap-1">
                <Award className="w-3 h-3 text-blue-400" /> Key Specializations
              </p>
              <div className="flex flex-wrap gap-1.5">
                {member.skills.slice(0, 5).map((skill, idx) => (
                  <span
                    key={idx}
                    className="px-2 py-0.5 rounded-md text-[11px] bg-blue-900/30 text-blue-300 border border-blue-700/40"
                  >
                    {skill}
                  </span>
                ))}
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-800/80 text-xs">
            ...
            <button
              ...
              className="text-xs font-semibold text-blue-400 hover:text-blue-300 flex items-center space-x-1 hover:underline"
            >
